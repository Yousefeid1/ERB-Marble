...
- **ميزان المراجعة:** تقرير فوري بأرصدة جميع الحسابات مع إمكانية التصدير
- **إدارة الشيكات:** تسجيل ومتابعة الشيكات الواردة والصادرة مع دورة الحالة (معلق → محصّل / مرتجع)
- **القيود المتكررة:** إنشاء قيود دورية تتكرر تلقائياً (شهري / ربع سنوي / سنوي) مع إمكانية التشغيل اليدوي
- **إغلاق السنة المالية:** نقل أرصدة نهاية السنة وتصفير حسابات الإيرادات والمصروفات تلقائياً

### 💰 المبيعات
- **فواتير المبيعات:** إنشاء فواتير بنود متعددة مع حساب الضريبة، دعم متعدد العملات، دورة حالة (مسودة → مرسلة → مدفوعة → ملغية)، طباعة PDF بالعربي
...
- **إدارة علاقات العملاء (CRM):** سجل تفاعلات كامل لكل عميل (مكالمات، بريد، زيارات، واتساب، شكاوى)، إدارة طلبات العينات، فلترة حسب المديونية والمدينة وتاريخ آخر تعامل
- **نظام التصدير:** إدارة أوامر التصدير الخارجي بعملات متعددة (EGP، USD، EUR، GBP، SAR، AED)، دورة حالة (مسودة → مؤكد → تم الشحن → تم التسليم → مسدد)
...
- **الألواح (Slabs):** مخزون الألواح المصنعة الناتجة عن القطع مع رفع صور متعددة لكل لوح
- **مراحل التصنيع:** تسجيل ومتابعة جميع مراحل الإنتاج (نشر رخام / جرانيت، تلميع، معالجة بالريزن والإيبوكسي، وتر جيت، وغيرها — 21 مرحلة مدعومة) مع احتساب تكلفة المناولة (رافعة، رافعة شوكية، عمالة)
- **إدارة الجودة:** تصنيف الألواح بدرجات الجودة (A / B / C / D) مع معاملات تسعير قابلة للتخصيص وضغط الصور تلقائياً عند الرفع
- **المنتجات:** كتالوج المنتجات النهائية مع الأسعار والمخزون والحد الأدنى

### 🏷️ مراكز التكلفة
- **مراكز التكلفة الفعلية:** إدارة مراكز التكلفة (محجر / ماكينة / تكاليف عامة / تصدير) وتخصيص التكاليف غير المباشرة على مراحل الإنتاج بأسس توزيع متعددة (مساحة / ساعات تشغيل / تكلفة مباشرة)
- **التكاليف غير المباشرة:** إدخال وتصنيف رواتب، كهرباء، مياه، إيجار، تسويق، وغيرها
...
| **التدفقات النقدية** | تحليل التدفقات النقدية التشغيلية والاستثمارية والتمويلية |
| **تقرير الهالك** | تتبع وتحليل الهالك من عمليات القطع |
| **تقرير المخزون** | تقييم المخزون الحالي بالتكلفة والقيمة السوقية |
| **تكلفة المتر المصنع** | تحليل تفصيلي لتكلفة إنتاج كل متر مربع |
| **ربحية التصدير** | تقرير ربحية أوامر التصدير بعملات متعددة |
| **حركة المخزون** | سجل كامل لحركات الدخول والخروج والتحويل |
| **مديونية العملاء** | تقرير أعمار الذمم المدينة التفصيلي لكل عميل |

### 🚛 اللوجستيك والتصدير
- **إدارة المستودعات:** دعم مستودعات متعددة (اسم، موقع، مسؤول، سعة)
- **الشحن والتوصيل:** تسجيل شحنات التسليم مع السائق، المركبة، بوليصة الشحن، دورة الحالة
- **تقارير التصدير:** تقرير مفصّل مع تنبيهات الشحنات المتأخرة
- **نظام التصدير:** إدارة أوامر التصدير الخارجي (مشترك مع قسم المبيعات)
...
| **موظف مبيعات** | لوحة التحكم، المبيعات، العملاء، الأعمار، عروض الأسعار، CRM، التصدير |
| **مدير مبيعات** | لوحة التحكم، المبيعات، العملاء، الأعمار، عروض الأسعار، CRM، التصدير، المدفوعات، تقرير P&L |
| **موظف مشتريات** | لوحة التحكم، المشتريات، الموردين، المدفوعات |
| **موظف تصنيع** | لوحة التحكم، الكتل، القطع، الألواح، مراحل التصنيع، إدارة الجودة، المنتجات |
| **مدير تصنيع** | لوحة التحكم، الكتل، القطع، الألواح، مراحل التصنيع، إدارة الجودة، مراكز التكلفة، المنتجات، تقرير الهالك، تقرير المخزون |
| **مشرف تصنيع** | لوحة التحكم، الكتل، القطع، الألواح، مراحل التصنيع، إدارة الجودة، المنتجات |
| **موظف لوجستيك** | لوحة التحكم، المستودعات، الشحنات، تقارير التصدير، نظام التصدير |
| **مدير قسم** | لوحة التحكم، الموظفين، سجل النشاط، المبيعات، العملاء، CRM، التصدير، تقرير P&L |
...
└── js/
    ...
    └── pages/
        ...
        ├── journal.js           # قيود اليومية + الحسابات + ميزان المراجعة + الشيكات + القيود المتكررة + إغلاق السنة
        ├── reports.js           # P&L + الميزانية + الهالك + المخزون + التدفقات النقدية + تكلفة المتر + ربحية التصدير + حركة المخزون + مديونية العملاء
        ├── crud-pages.js        # المنتجات + المصروفات + الإعدادات + الإشعارات
        ├── employees.js         # الموظفين + سجل النشاط
        ├── logistics.js         # المستودعات + الشحنات + تقارير التصدير
        ├── manufacturing.js     # مراحل التصنيع (21 مرحلة) + حساب تكلفة المناولة
        ├── cost-centers.js      # مراكز التكلفة الفعلية + التكاليف غير المباشرة + توزيع التكاليف
        ├── export.js            # نظام التصدير + أوامر التصدير + تقارير الربحية بعملات متعددة
        ├── quality.js           # إدارة الجودة + درجات الجودة + رفع الصور + ضغط الصور
        └── crm.js               # إدارة علاقات العملاء + سجل التفاعلات + طلبات العينات
```
...
| مدير مبيعات | `salesmgr@marble.com` | `[محمي — يُعيَّن عند التثبيت]` |
